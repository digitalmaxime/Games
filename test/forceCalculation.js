export default function calculateForceWall(ball, angle, linePosition) {    
    ...
    forceVector.x = (radiusVector.x * Math.abs(dotProduct) * 0.95);
    forceVector.y = (radiusVector.y * Math.abs(dotProduct) * 0.95);
